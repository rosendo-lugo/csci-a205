# This prgram allows the user to see the time zone
# for a selected city.
import tkinter
...
class TimeZone:
    ...
    def __build_listbox(self):
        ...
        self.city_listbox.bind(
            '<<ListboxSelected>>', self.__display_time_zone)
        
        # Populate the Listbox.
        for city in self.__cities:
            self.city_listbox.insert(tkinter.END, city)
            
    # This mthod creats the output_frame and its contents.
